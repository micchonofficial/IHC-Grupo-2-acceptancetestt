...
Then se muestra en la pantalla un mensaje indicando que el usuario empresa aún no ha ingresado los datos de las características de 
la oferta ni el número de vacantes disponibles.
