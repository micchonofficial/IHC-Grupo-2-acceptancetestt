...
Then la página web deberá mostrar el proceso de la compra de la oferta, en una barra como forma de medición siendo el inicio 0% y el final 100%, mostrará el estado marcando la barra con un color.
